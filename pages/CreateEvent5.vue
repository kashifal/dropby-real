<template lang="">
          ...
          <div class="mx-auto w-full max-w-7xl">
            ...
            C351,29.5,380.5,0,416.8,0"
                    ...
                    <div class="hidden items-center gap-2 ps-6 font-sans sm:flex">
                      ...
                      <h2 class="text-muted-800 font-semibold dark:text-white">Event Cover</h2>
                    </div>
                ...
                <div class="pb-32 pt-24">
                  <div>
                    <div class="mb-10 text-center">
                      <p class="nui-heading nui-heading-2xl nui-weight-semibold nui-lead-normal text-muted-800 dark:text-white" tag="h1"><span>Event Cover</span></p>
                      <p class="nui-paragraph nui-paragraph-sm nui-weight-normal nui-lead-normal text-muted-500 dark:text-muted-400"><span>We recomend uploading a video to get more traction to your event. You can also add image aswell.</span></p>
                    </div>
                    <div class="mx-auto flex w-full max-w-[20rem] flex-col gap-3 px-4">
    ...
    >
      ...
      >
        <div
          v-if="!files?.length"
          class="nui-focus border-muted-300 dark:border-muted-700 hover:border-muted-400 focus:border-muted-400 dark:hover:border-muted-600 dark:focus:border-muted-700 group cursor-pointer rounded-lg border-[3px] border-dashed p-8 h-[460px]  transition-colors duration-300"
          tabindex="0"
          role="button"
          @click="open"
                ...
                <div>
                  <div class="fixed inset-x-0 bottom-6 z-20 mx-auto w-full max-w-[304px]">
                    <div class="nui-card nui-card-rounded-sm nui-card-default shadow-muted-300/30 dark:shadow-muted-800/30 flex items-center justify-between gap-2 rounded-2xl p-4 shadow-xl">
                      <NuxtLink to="/CreateEvent4" class="router-link-active nui-button nui-button-md nui-button-rounded-lg nui-button-solid nui-button-default w-full" disabled="false"
          ><span>Previous</span
          ><!----></NuxtLink
        ><NuxtLink to="/CreateEvent6" type="submit" rel="" target="" class="nui-button nui-button-md nui-button-rounded-lg nui-button-solid nui-button-primary w-full">
          <span>Continue</span
          ><!---->
          </NuxtLink>
                    </div>
